$(document).ready(function () {
    ...
    $(document).on('click', '.update-product-button', function () {
        ...
        $.getJSON("http://localhost/ksp-example/product/read_one.php?product_id=" + id, function (data) {
    ...
    <tr>
        <td>Product ID</td>
            <td><input value=\"` + product_id + `\" type='text' name='product_id' class='form-control' required /></td>
        </tr>
        ...
        <tr>
            <td>Product Name</td>
            <td><input value=\"` + product_name + `\" name='product_name' class='form-control' required /></td>
        </tr>
        ...
        <tr>
            <td>Category Name</td>
            <td><input value=\"` + category_name + `\"  name='category_name' class='form-control' required /></td>
        </tr>
    ...
    $(document).on('submit', '#update-product-form', function () {
        ...
        $.ajax({
            url: "http://localhost/ksp-example/product/update.php",
            type: "POST",
